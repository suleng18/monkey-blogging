...
const SignUpPage = () => {
  ...
  const handleSignUp = async (values) => {
    ...
    await updateProfile(auth.currentUser, {
      ...
      photoURL:
        'https://images.unsplash.com/photo-1672151576478-a4ca761424ad?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80',
    });
